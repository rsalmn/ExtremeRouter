# ExtremeRouter PR and Coverage Instructions
...
- If a PR changes production code in `src/`, `open-sse/`, `cli/`, or `scripts/`, it must include automated tests in the same PR.
