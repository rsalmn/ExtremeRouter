...
vi.mock("@/lib/oauth/utils/server", () => {
  const noop = () => {};
  return {
    startCodexProxy: noop, stopCodexProxy: noop, registerCodexSession: noop,
    getCodexSessionStatus: () => null, clearCodexSession: noop,
    startXaiProxy: noop, stopXaiProxy: noop, registerXaiSession: noop,
    getXaiSessionStatus: () => null, clearXaiSession: noop,
    startXiaomiMimoProxy: async () => ({ success: true, port: 56122, callbackUrl: "http://127.0.0.1:56122/callback" }),
