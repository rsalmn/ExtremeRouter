export default {
  ...
  models: [
    ...
    // Async video jobs (POST /videos → { id, status }, poll GET /videos/{id}).
  ...
  // Async video jobs. Docs: https://openrouter.ai/docs/api/api-reference/videos
  // Creation POSTs to the collection root (no /generations suffix).
  videoConfig: {
    baseUrl: "https://openrouter.ai/api/v1/videos",
    headers: {"HTTP-Referer":"https://endpoint-proxy.local","X-Title":"Endpoint Proxy"},
    bodyFields: ["model","prompt","duration","aspect_ratio","resolution","seed","negative_prompt"],
  },
