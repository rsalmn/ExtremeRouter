...
export default {
  ...
  display: {
    ...
    notice: {
      ...
      text: "Connect a Xiaomi MiMo API key (sk-) for the cloud API, or sign in to MiMo Desktop to unlock the Preview models and weekly quota.",
    },
  },
  category: "oauth",
  ...
  // Handled by the Xiaomi MiMo OAuth helpers, not the generic PKCE pipeline.
  oauth: {
    custom: true,
