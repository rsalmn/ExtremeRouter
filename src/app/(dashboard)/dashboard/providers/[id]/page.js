...
import { Card, Button, Modal, CardSkeleton, OAuthModal, KiroOAuthWrapper, CursorAuthModal, XiaomiMimoAuthModal, ZedAuthModal, KimiDesktopAuthModal, KimiDesktopQuotaCard, OneMinAuthModal, QwenAuthModal, WpStudioAuthModal, IFlowCookieModal, GitLabAuthModal, EditConnectionModal, ConfirmModal } from "@/shared/components";
  ...
  return (
    <div className="flex min-w-0 flex-col gap-5">
      ...
      {providerId === "kiro" ? (
        ...
        <XiaomiMimoAuthModal isOpen={showOAuthModal} onSuccess={handleOAuthSuccess} onClose={() => setShowOAuthModal(false)} />
      ) : providerId === "gitlab" ? (
